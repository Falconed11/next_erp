...
const WAIcon = (props) => {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M20.52 3.48A11.82 11.82 0 0 0 12 0a11.82 11.82 0 0 0-8.52 3.48A11.82 11.82 0 0 0 0 12a11.82 11.82 0 0 0 1.68 6L0 24l6.24-1.68A11.82 11.82 0 0 0 12 24a11.82 11.82 0 0 0 8.52-3.48A11.82 11.82 0 0 0 24 12a11.82 11.82 0 0 0-3.48-8.52zM12 21.6a9.49 9.49 0 0 1-4.92-1.32l-.36-.24-3.72 1 1-3.6-.24-.36A9.48 9.48 0 0 1 2.4 12a9.49 9.49 0 0 1 9.6-9.6A9.49 9.49 0 0 1 21.6 12a9.49 9.49 0 0 1-9.6 9.6zm5.28-7.44c-.3-.15-1.8-.9-2.1-1-.3-.15-.51-.15-.72.15-.21.3-.84 1-.99 1.2-.15.15-.3.15-.6 0-.3-.15-1.2-.45-2.28-1.44-.84-.75-1.44-1.68-1.59-1.98-.15-.3 0-.45.15-.6.15-.15.3-.3.45-.45.15-.15.21-.3.3-.45.09-.15.06-.3 0-.45-.06-.15-.72-1.8-.99-2.46-.26-.63-.51-.54-.72-.54h-.6c-.15 0-.45.06-.69.3s-.9.84-.9 2.04 1.08 2.4 1.23 2.55c.15.15 2.13 3.24 5.1 4.56.72.3 1.29.48 1.74.6.72.24 1.38.21 1.89.12.57-.09 1.8-.75 2.04-1.47.24-.72.24-1.32.18-1.44-.06-.12-.24-.18-.54-.33z" />
    </svg>
  );
};
